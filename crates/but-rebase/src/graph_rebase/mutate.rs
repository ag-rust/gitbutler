...
impl<M: RefMetadata> Editor<'_, M> {
    ...
    /// their picks, exactly as reference nodes did when refs lived in the arena.
    ///
    ...
    /// through the layout machinery; a DEAD one (which upstream-integration retention
