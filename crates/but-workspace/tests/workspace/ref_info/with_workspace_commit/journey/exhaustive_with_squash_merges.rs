...
fn j01_unborn() -> anyhow::Result<()> {
    ...
    snapbox::assert_data_eq!(
        description,
        snapbox::str![[r#"
a newly initialized repository
...
fn j02_first_commit() -> anyhow::Result<()> {
    ...
    snapbox::assert_data_eq!(
        description,
        snapbox::str![[r#"
the root commit is now present locally
...
"#]]
    ...
    snapbox::assert_data_eq!(
        visualize_commit_graph_all(&repo)?,
        snapbox::str![[r#"
* fafd9d0 (HEAD -> main, origin/main) init
...
fn j04_create_workspace() -> anyhow::Result<()> {
    ...
    snapbox::assert_data_eq!(
        description,
        snapbox::str![[r#"
An official workspace was created, with nothing in it
...
fn j05_empty_stack() -> anyhow::Result<()> {
    ...
    snapbox::assert_data_eq!(
        description,
        snapbox::str![[r#"
an empty stack with nothing in it
...
fn j06_create_commit_in_stack() -> anyhow::Result<()> {
    ...
    snapbox::assert_data_eq!(
        description,
        snapbox::str![[r#"
Create a new commit in the newly added stack S1
...
fn j07_push_commit() -> anyhow::Result<()> {
    ...
    snapbox::assert_data_eq!(
        description,
        snapbox::str![[r#"
push S1 to the remote which is then up-to-date
...
fn j09_rewritten_remote_and_local_commit() -> anyhow::Result<()> {
    ...
    snapbox::assert_data_eq!(
        description,
        snapbox::str![[r#"
The new local commit was rewritten after pushing it to the remote
