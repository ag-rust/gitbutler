...
"#]]
        ...
        snapbox::assert_data_eq!(
            visualize_tree(commit.peel_to_tree()?.id()).to_string(),
            snapbox::str![[r#"
f53c910
└── A:100644:f70f10e "A\n"
...
"#]]
        ...
        // anonymous stacks preserve order after filtered named parents
        snapbox::assert_data_eq!(
            out.to_debug(),
            snapbox::str![[r#"
Outcome {
