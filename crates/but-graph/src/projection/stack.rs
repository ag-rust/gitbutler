...
impl Stack {
    ...
    pub(crate) fn recompute_last_segment_base(&mut self, graph: &Graph) {
...
pub struct StackSegment {
    ...
    /// This is `true` for exactly one segment in a workspace if the entrypoint of [the traversal](Graph::from_tip())
